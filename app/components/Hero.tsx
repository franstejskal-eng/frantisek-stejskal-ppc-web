        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="inline-flex items-center gap-2 bg-[oklch(0.55_0.22_260/0.15)] border border-[oklch(0.55_0.22_260/0.35)] text-[oklch(0.70_0.18_260)] text-xs font-medium px-3 py-1.5 rounded-full mb-8">
              ...
              Certifikovaný Google Ads specialista
            </div>

            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-[1.1] tracking-tight mb-6">
              Vaše reklamy{" "}
              <span className="text-[oklch(0.55_0.22_260)]">utrácejí.</span>
              <br />
              Měly by vydělávat.
            </h1>

            <p className="text-lg text-[oklch(0.65_0_0)] leading-relaxed mb-10 max-w-lg">
              Pomáhám firmám přestat plýtvat reklamním rozpočtem. Z Google Ads a
              Meta kampaní dělám skutečný, měřitelný zdroj zakázek – s jasným
              reportingem, který vždy víte, kde jsou vaše peníze.
            </p>
            ...
            <div className="mt-12 pt-8 border-t border-[oklch(0.18_0_0)] grid grid-cols-3 gap-6">
              {[
                ...
                { value: "70+", label: "úspěšných projektů" },
                { value: "Od 2019", label: "na trhu" },
              ].map((stat) => (
                <div key={stat.label}>
                  <div className="text-2xl font-bold text-white mb-1">
                    {stat.value}
                  </div>
                  <div className="text-xs text-[oklch(0.55_0_0)] leading-snug">
                    {stat.label}
                  </div>
                </div>
              ))}
            ...
            <div className="relative">
              ...
              <div className="relative overflow-hidden rounded-2xl border border-[oklch(0.20_0.06_260/0.4)] shadow-2xl">
                <Image
                  ...
                  priority
                />
                {/* Bottom overlay for seamless blend */}
